...
var updatenewuma = async function(obj,sqlcon){
  ...
  var query = `INSERT INTO umasingle (uma_name, uma_speed, uma_stamina, uma_power, uma_grit, uma_intelligence, uma_total, uma_ranknum, uma_rank, uma_sc1, uma_sc2, uma_sc3, uma_sc4, uma_sc5, uma_sc6, uma_scl1, uma_scl2, uma_scl3, uma_scl4, uma_scl5, uma_scl6, uma_wheninsert) 
              ...
              ${obj.cardItemLV[0]}, ${obj.cardItemLV[1]}, ${obj.cardItemLV[2]}, ${obj.cardItemLV[3]}, ${obj.cardItemLV[4]}, ${obj.cardItemLV[5]}, '${nowtime}')`
